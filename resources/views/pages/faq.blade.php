...
<section class="parallax-bg light-typo padding-top-bottom" data-parallax-background="images/cherry2.jpg" data-stellar-background-ratio="0.25" style="background-image: url(&quot;images/cherry-harvest-dark.jpg&quot;); background-position: 50% 3.5px;">
			...
			<div class="container">
				...
				<br>
				<h2 class="text-center post-title">Frequently Asked Questions (FAQ)</h2>
				<br>
				...
				<div class="row">
					...
					<header class="post-header">
						...
						<div>
							...
							<p class="red-intro">The BC Cherry Association is the umbrella organization representing various grower, packers, shippers, brokers, scientists, and industry sales people and sponsors.</p>
							<p class="red-intro">We strive to grow a high quality product for various markets all over the world. Currently, there is a great demand for Canadian Cherries. This Q&amp;A is intended to help answer your questions regarding our industry and market opportunities.</p>
							
							<p class="red-intro">**Please note that the BCCA is not a marketing agency or a broker. This website is a vessel for disseminating general information to interested parties and connecting you with potential producers.</p>
							
							
							<p><strong>Purchasing Canadian Cherries</strong></p>
							<p>Q: Where can I buy Canadian Cherries?</p>
							<blockquote>
								<p><em>The first place to look is at our Sales Directory. Here you will find direct marketers as well as Brokers and Sales Agents</em>.</p>
							</blockquote>
