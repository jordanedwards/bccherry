...
@section('content')
    ...
    @foreach($news as $newsItem)
        ...
        <header class="post-header">
            ...
            <h3><a href="#" title="Read post: Post with single featured image"><i
                            class="fa fa-bookmark fa-lg"></i> {{ $newsItem->title }}</a></h3>

            <ul class="post-meta small">
                <li><i class="fa fa-calendar"></i>{{ $newsItem->created_at->format('F d Y') }}</li>
