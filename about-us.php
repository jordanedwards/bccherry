					...
					<div id="single-post" class="col-sm-8">
						...
						<article class="post-entry">
							...
							<section class="white-bg">
								...
								<div class="row">
									<div class="content">
										<div class="pf-content"><p>Formerly called the Okanagan Kootenay Cherry Growers' Association (OKCGA), the organization was formed in 1998 by a small group of cherry growers seeking to pool financial resources to increase research and development of cherry production in the region. Through a voluntary contribution of a penny per pound from each grower, significant gains have been made - not just in research, but in other areas, such as minor use pesticide registration, orchard and employment issues, and forums for growers. Since inception, annual grower contributions, partnered with provincial and federal programs, have enabled five or six priority research projects annually - working with the Pacific Agriculture Research Centre (PARC) and other researchers and consultants.</p>
<p>The executive contribute many hours on other matters, such as chemical registration, communication of horticultural information, field days and forums. In recent years the organization has broadened it scope to address trade and market access and development issues - to keep ahead of the major increases in production. The Board has two major committees - Research and Development, and Market Access and Promotion. Each of these committees includes growers and other specialists and industry stakeholders - providing the experience and knowledge to prioritize the issues and guide the work to be done.</p>
<p>Other services to members include an online horticultural forum, orchard listings for employment, classified advertising, and marketing directory to help buyers of all kinds find the fruit they are looking for.</p>
<p>Growers are strongly urged to join and contribute the annual research levy to enable the BCCA to do even more work in the future. Print out and mail in the attached membershipform.</p>
<p>Research Projects conducted in the last few years are listed below. Related reports are available in full in the Members' Area.<br>
...
(2011) NC 140 Training and Rootstock Trials D&amp;G Nielsen(2011) Irrigation and Crop Load Studies for Coping with Drought D &amp; G Nielsen<br>
(2011) Starling Population Control  J Neuhauser<br>
(2010) Spotted Wing Drosophila Similkameen Monitoring and Trap Trials L. Edwards, T. Richardson<br>
...
(2008) Cherry response to Management Treatments and Tree Effects from Spray Applications: D&amp;G Neilson<br>
...
(2005) Microbiological quality of hydro-cooler water in cherry packing plants and evaluation of alternative sanitizers: Dr. P Delaquis<br>
(2004) Cherry Fruit Fly Control with GF-120 NF Bait<br>
(2004) Development of a disease monitoring model for cherry powdery mildew – Progress Report 2004<br>
...
(2002) Nutritional factors associated with harvest quality and post harvest longevity of sweet cherry<br>
(2002) The Dispersal of the Western cherry fruit fly R. indifferens (Diptera: Tephritidae) in Structured Environments</p>
</div>	
									</div>
								</div>
